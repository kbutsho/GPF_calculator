...
export const DepositMethodLabelsEn = {
  [DepositMethods.MONTHWISE]: "Month-wise (statement rule)",
  [DepositMethods.FLAT]: "Flat — full-year rate",
  [DepositMethods.HALF_YEAR]: "Half-year (6 months)",
};

export const RoundingLabelsEn = {
  [Rounding.TRUNCATE]: "Truncate — drop past the paisa (statement rule)",
  [Rounding.ROUND]: "Round — to the nearest paisa",
};
...
export const UserStatusLabels = {
  [UserStatus.ACTIVE]: { bn: "সক্রিয়", en: "Active", color: "success" },
  [UserStatus.INACTIVE]: { bn: "নিষ্ক্রিয়", en: "Inactive", color: "secondary" },
};
...
export const UserRoleLabels = {
  [UserRole.USER]: { bn: "ব্যবহারকারী", en: "User" },
  [UserRole.ADMIN]: { bn: "অ্যাডমিন", en: "Admin" },
};
